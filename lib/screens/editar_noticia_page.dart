...
class _EditarNoticiaPageState extends State<EditarNoticiaPage> {
  ...
  Future<TimeOfDay?> _showHybridTimePicker12h(
    ...
    final hourTextCtrl = TextEditingController(text: selHour12.toString().padLeft(2, '0'));
    final minTextCtrl  = TextEditingController(text: selMinute.toString().padLeft(2, '0'));
    String? errorText;
    ...
    int? _digitFromKey(LogicalKeyboardKey k) {
      switch (k) {
        ...
        case LogicalKeyboardKey.numpad0: return 0;
        case LogicalKeyboardKey.digit1:
        case LogicalKeyboardKey.numpad1: return 1;
        case LogicalKeyboardKey.digit2:
        case LogicalKeyboardKey.numpad2: return 2;
        case LogicalKeyboardKey.digit3:
        case LogicalKeyboardKey.numpad3: return 3;
        case LogicalKeyboardKey.digit4:
        case LogicalKeyboardKey.numpad4: return 4;
        case LogicalKeyboardKey.digit5:
        case LogicalKeyboardKey.numpad5: return 5;
        case LogicalKeyboardKey.digit6:
        case LogicalKeyboardKey.numpad6: return 6;
        case LogicalKeyboardKey.digit7:
        case LogicalKeyboardKey.numpad7: return 7;
        case LogicalKeyboardKey.digit8:
        case LogicalKeyboardKey.numpad8: return 8;
        case LogicalKeyboardKey.digit9:
        case LogicalKeyboardKey.numpad9: return 9;
        default: return null;
      }
    }
    ...
    void _animateHourTo(int h12) {
      ...
      if (idx >= 0) {
        wheelHourCtrl.animateToItem(idx, duration: const Duration(milliseconds: 120), curve: Curves.easeOut);
      }
    }
    ...
    void _animateMinuteTo(int m) {
      ...
      if (idx >= 0) {
        wheelMinCtrl.animateToItem(idx, duration: const Duration(milliseconds: 120), curve: Curves.easeOut);
      }
    }

    void _animateAmPmTo(bool pm) {
      wheelAmpmCtrl.animateToItem(pm ? 1 : 0, duration: const Duration(milliseconds: 120), curve: Curves.easeOut);
    }
    ...
    void _pushDigitForWheel(_TimeSection section, int digit, void Function(void Function()) setModalState) {
      if (_closing) return;
        ...
        return StatefulBuilder(
          builder: (ctx, setModalState) {
            ...
            InputDecoration deco(String label) => InputDecoration(
                  ...
                  border: OutlineInputBorder(borderRadius: BorderRadius.circular(boxRadius)),
                );
            ...
            Widget wheelBox({
              ...
              return Focus(
                ...
                onKeyEvent: (node, event) {
                  ...
                  if (d != null && (section == _TimeSection.hour || section == _TimeSection.minute)) {
                                ...
                                child: CupertinoPicker(
                                  ...
                                  children: [
                                    for (final h in hours)
                                      Center(child: Text(h.toString().padLeft(2, '0'), style: itemStyle(h == selHour12))),
                                  ],
                                ),
                              ),
                              const SizedBox(width: 10),
                                ...
                                child: CupertinoPicker(
                                  ...
                                  children: [
                                    for (final m in minutes)
                                      Center(child: Text(m.toString().padLeft(2, '0'), style: itemStyle(m == selMinute))),
                                  ],
                                ),
                              ),
                              const SizedBox(width: 14),
                            ...
                            children: [
                                ...
                                child: TextField(
                                  ...
                                  onEditingComplete: () {
                                    if (hourTextCtrl.text.length == 1) {
                                      hourTextCtrl.text = hourTextCtrl.text.padLeft(2, '0');
                                    }
                                  },
                              ...
                              SizedBox(
                                ...
                                child: TextField(
                                  ...
                                  textAlign: TextAlign.center,
                                  style: const TextStyle(fontSize: 22, fontWeight: FontWeight.w800),
                                  decoration: deco(minuteInterval == 1 ? 'Min (00–59)' : 'Min (×$minuteInterval)'),
                                  onChanged: (_) {
                                    if (_closing) return;
                                    safeSetModalState(() => errorText = null);
                                  },
                                  onEditingComplete: () {
                                    if (minTextCtrl.text.length == 1) {
                                      minTextCtrl.text = minTextCtrl.text.padLeft(2, '0');
                                    }
                                  },
                                  onSubmitted: (_) => accept(),
                                ),
